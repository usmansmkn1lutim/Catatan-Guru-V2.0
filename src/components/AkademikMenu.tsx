    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-white/40 dark:border-white/10">
        <div className="space-y-1">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-rose-500/10 dark:bg-rose-500/20 border border-rose-500/20 dark:border-rose-400/30 text-rose-600 dark:text-rose-300 text-xs font-semibold">
        ...
        {menus.map((menu) => (
          ...
          >
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-black dark:text-white group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors">
                {menu.label}
              </h3>
            ...
            <div className="flex items-center justify-between pt-5 mt-4 border-t border-slate-200/50 dark:border-white/10 text-xs font-bold text-rose-600 dark:text-rose-400">
              <span>Buka Menu</span>
